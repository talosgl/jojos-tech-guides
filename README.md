...
## Setup Guides
- **[Get Set Up to Install and Run Python Scripts on Your Computer with pip](docs/python/script-setup.md)** - Get from "I found a Python script" to "it's running on my computer" with a clean, sustainable setup.
...
- **[How to Annotate Code Without Modifying Source Files](docs/dev-workflow/line-note-junction.md)** - Take notes on source codebases where you cannot easily or safely modify and add traditional code comments.
